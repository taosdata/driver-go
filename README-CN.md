...
|------------------|--------------------------|--------------------------------------------|
| v3.6.0           | 3.3.5.0及以上               | stmt2 原生写入、DSN 支持密码包含特殊字符(url.QueryEscape) |
| v3.5.8           | 3.3.2.0及以上 / 3.1.2.0及以上  | 修复空指针异常                                    |
| v3.5.7           | 3.3.2.0及以上 / 3.1.2.0及以上  | taosWS 和 taosRestful 支持传入 request id       |
| v3.5.6           | 3.3.2.0及以上 / 3.1.2.0及以上  | 提升 websocket 查询和写入性能                       |
| v3.5.5           | 3.2.3.0及以上 / 3.1.1.27及以上 | restful 支持跳过 ssl 证书检查                      |
| v3.5.4           | 3.2.3.0及以上 / 3.1.1.27及以上 | 兼容 TDengine 3.3.0.0 tmq raw data           |
| v3.5.3           | 3.2.3.0及以上 / 3.1.1.27及以上 | 重构 taosWS                                  |
| v3.5.2           | 3.2.3.0及以上 / 3.1.1.27及以上 | websocket 压缩和优化消息订阅性能                      |
| v3.5.1           | 3.2.1.0及以上 / 3.1.1.13及以上 | 原生 stmt 查询和 geometry 类型支持                  |
| v3.5.0           | 3.0.5.0及以上               | 获取消费进度及按照指定进度开始消费                          |
| v3.3.1           | 3.0.4.1及以上               | 基于 websocket 的 schemaless 协议写入             |
| v3.1.0           | 3.0.2.2及以上               | 提供贴近 kafka 的订阅 api                         |
| v3.0.4           | 3.0.2.2及以上               | 新增 request id 相关接口                         |
| v3.0.3           | 3.0.1.5及以上               | 基于 websocket 的 statement 写入                |
| v3.0.2           | 3.0.1.5及以上               | 基于 websocket 的数据查询和写入                      |
| v3.0.1           | 3.0.0.0及以上               | 基于 websocket 的消息订阅                         |
| v3.0.0           | 3.0.0.0及以上               | 适配 TDengine 3.0 查询和写入                      |
